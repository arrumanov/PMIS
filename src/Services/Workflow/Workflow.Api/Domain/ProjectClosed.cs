...
namespace Workflow.Api.Domain
{
    public class ProjectClosed
    {
        ...
        public class Handler : IRequestHandler<ProjectClosed.Command, Unit>
        {
            ...
            public async Task<Unit> Handle(ProjectClosed.Command request, CancellationToken cancellationToken)
            {
