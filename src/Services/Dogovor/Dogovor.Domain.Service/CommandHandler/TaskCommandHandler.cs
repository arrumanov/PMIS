...
using ProjectQuery = Dogovor.Infrastructure.Database.Query.Model.Project;
...
namespace Dogovor.Domain.Service.CommandHandler
{
                                      ...
                                      IRequestHandler<RemoveTaskCommand, bool>
    {
        ...
        {
            var task = _TaskRepository.GetById(request.Id).Result.ToDomain<Dogovor.Domain.Model.Task>(_Mapper);
        ...
        {
            var projectDomain = _ProjectRepository.GetById(request.ProjectId).Result.ToDomain<Dogovor.Domain.Model.Project>(_Mapper);
