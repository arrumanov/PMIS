...
export default observer(() => {
  ...
  const headerExtra = [
    <Radio.Group key="group" buttonStyle="solid" value={activeTab} onChange={onTabChange}>
      <Radio.Button value={CLIENT_TYPES.ALL}>All</Radio.Button>
      <Radio.Button value={CLIENT_TYPES.NAT}>Natural</Radio.Button>
      <Radio.Button value={CLIENT_TYPES.LEG}>Legal</Radio.Button>
    </Radio.Group>,
  ];
